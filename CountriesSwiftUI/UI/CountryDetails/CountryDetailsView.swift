...
struct CountryDetails: View {
    ...
    @State private var countryDetailsState: Loadable<DBModel.CountryDetails>
    ...
    init(country: DBModel.Country, details: Loadable<DBModel.CountryDetails> = .notRequested) {
        ...
        self._countryDetailsState = .init(initialValue: details)
    }
...
private extension CountryDetails {
    ...
    func loadCountryDetails(forceReload: Bool) {
        // MVVM flow: detail screen requests data through Interactor and reacts to Loadable state changes.
        $countryDetailsState.load {
...
private extension CountryDetails {
    ...
    func loadingView() -> some View {
        VStack {
            ...
            Button(action: {
                self.countryDetailsState.cancelLoading()
